...
public class Loops
{
    ...
    public static void challenge0(){ //works
    ...
    public static void challenge1(){ //works
    ...
    public static void challenge2(){ //works
    ...
    public static void challenge3(){ //works
    ...
    public static void challenge4(){ //works
        for (int i=1; i<6; i++){            //1 1 1 1 1 
